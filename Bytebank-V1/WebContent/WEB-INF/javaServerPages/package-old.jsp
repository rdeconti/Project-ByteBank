...
<%@ page import="java.util.*, br.com.bytebank.Model.PackageModel, br.com.bytebank.DataAccessObject.PackageDataAccessObject" %>
			...
			<div class="part-central">
				...
				<table>
					...
					<tbody>
						...
						<% 
						PackageDataAccessObject packageDataAccessObject = new PackageDataAccessObject();
						List<PackageModel> packages = packageDataAccessObject.readAll();
					
						for(PackageModel myPackage : packages) { 
						%>					
							<tr>
								<td><%=myPackage.getPackageCode() %></td>
								<td><%=myPackage.getPackageStatus() %></td>
								<td><%=myPackage.getPackageLevel() %></td>
								<td><%=myPackage.getPackageName() %></td>
								<td><%=myPackage.getPackageDescription() %></td>
								<td><%=myPackage.getPackageLimit() %></td>
								<td><%=myPackage.getPackageFee() %></td>
